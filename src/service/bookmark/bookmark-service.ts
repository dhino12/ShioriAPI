import { BookmarkCreateRequest, BookmarkUpdateRequest } from "../../dto/request/bookmark-request";
import { BookmarkResponse, toBookmarkResponse, toBookmarkResponses } from "../../dto/response/bookmark-response";
import { ResponseError } from "../../error/response-error";
import { toBookmarkModel } from "../../helpers/mappers";
import { IBookmarkRepository } from "../../repository/bookmark/ibookmark-repository";
